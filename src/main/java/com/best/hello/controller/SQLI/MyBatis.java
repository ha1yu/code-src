...
public class MyBatis {
    ...
    public List<Users> queryById(@PathVariable String id) {
    ...
    public List<Users> orderBy(String field, String sort) {
    ...
    public List<Users> order2(String field) {
    ...
    public List<Users> queryByUser(String user) {
    ...
    public List<Users> queryById(@PathVariable Integer id) {
    ...
    public List<Users> orderBySafe(String field) {
